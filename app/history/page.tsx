  ...
  return (
    <main className="min-h-screen bg-ladBlack text-white font-sans">
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto max-w-4xl px-4 pb-14 pt-16 text-left md:pt-20">
      ...
      <section className="container mx-auto max-w-4xl px-4 py-16">
        <div className="space-y-5 text-gray-300">
          <p>
            Desa Gubugklakah memiliki sejarah panjang yang tumbuh dari kehidupan agraris, ritual adat,
            dan semangat gotong royong masyarakat setempat.
          </p>
          <p>
            Lembaga Adat Desa hadir sebagai wadah dalam menjaga nilai-nilai luhur, menyatukan komunitas,
            dan memastikan warisan budaya tetap hidup di tengah perkembangan zaman.
          </p>
          <p>
            Dari upacara adat hingga pengelolaan lingkungan, sejarah desa ini menjadi fondasi penting
            dalam membangun kehidupan masyarakat yang harmonis dan berkelanjutan.
          </p>
        </div>
      </section>
    </main>
