  ...
  return (
    <main className="min-h-screen bg-ladBlack text-white font-sans">
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto max-w-6xl px-4 pb-14 pt-16 text-left md:pt-20">
      ...
      <section className="container mx-auto max-w-6xl px-4 py-16">
        <div className="grid gap-6 md:grid-cols-3">
          {['Upacara Adat', 'Kegiatan Warga', 'Lingkungan Desa'].map((item) => (
            <div key={item} className="rounded-lg border border-zinc-800 bg-zinc-900 p-6 text-center">
              <div className="mb-4 h-40 rounded-md bg-gradient-to-br from-ladGold/30 to-zinc-700" />
              <h3 className="text-xl font-semibold text-ladGold">{item}</h3>
            </div>
          ))}
        </div>
      </section>
