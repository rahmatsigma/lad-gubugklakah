  ...
  return (
    <main className="min-h-screen bg-ladBlack text-white font-sans">
      ...
      <section className="container mx-auto max-w-4xl px-4 py-16">
        <article className="space-y-6 rounded-xl border border-zinc-800 bg-zinc-900 p-8 text-gray-300">
          <p>
            Artikel ini menjadi wadah untuk menyampaikan gagasan, pengalaman, serta informasi yang
            memperkuat pelestarian budaya dan semangat gotong royong.
          </p>
          <p>
            Melalui tulisan dan dokumentasi, masyarakat dapat belajar tentang tradisi, sejarah, dan
            inovasi yang menjaga Desa Gubugklakah tetap relevan dan maju.
          </p>
        </article>
      </section>
    </main>
